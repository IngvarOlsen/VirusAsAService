...
def sanitise(input_value, input_type="string"): # Verifies correct data type & blocks SQL injection patterns
    blacklist = [r"%2B", r"--", r";", r"union", r"select", r"insert", r"update", r"delete", r"drop", r"alter", r"create", r"union", r"join", r"truncate", r"replace", r"into", r"values", r"where", r"from", r"having", r"group by", r"order by", r"limit", r"offset"]
    # Validate input type
